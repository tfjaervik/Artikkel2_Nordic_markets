...
table_3 <- kable(estimates_df,
                 ...
                 label = "beta_ltd_sorted_future_returns") %>% 
  kable_styling() %>% 
...
save(table_3, file = "data/rdata/rdata_tables/double_sorts_beta_ltd.Rdata")

# Load the table and set the positioning

load("data/rdata/rdata_tables/double_sorts_beta_ltd.Rdata")
table_3 <- table_3 %>% 
  TexTools::ltx_placement(tbl_placement = "H")


TexTools::write_tex(table_3, path = "_tables/double_sorts_beta_ltd")    
