...
table_3 <- kable(estimates_df,
                 ...
                 label = "cokurtosis_ltd_sorted_future_returns_equal_weighted") %>% 
  kable_styling() %>% 
...
save(table_3, file = "data/rdata/rdata_tables/double_sorts_cokurtosis_ltd_equal_weighted.Rdata")

# Load the table and set the positioning

load("data/rdata/rdata_tables/double_sorts_cokurtosis_ltd_equal_weighted.Rdata")
table_3 <- table_3 %>% 
  TexTools::ltx_placement(tbl_placement = "H")


TexTools::write_tex(table_3, path = "_tables/double_sorts_cokurtosis_ltd_equal_weighted") 
