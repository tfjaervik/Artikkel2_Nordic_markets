...
TexTools::write_tex(reg_table_1, path = "_tables/reg_clustered_on_time_1_ltd_nll")
...
reg_7 <- feols(lead_ret ~ ltd_nll + beta + downside_beta + upside_beta + coskewness + cokurtosis + hml,
               cluster = c("YearMonth"), data = df)

reg_8 <- feols(lead_ret ~ ltd_nll + beta + downside_beta + upside_beta + coskewness + cokurtosis + hml + smb,
               cluster = c("YearMonth"), data = df)
...
TexTools::write_tex(reg_table_2, path = "_tables/reg_clustered_on_time_2_ltd_nll")
